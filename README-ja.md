...
AI Agent が長い思考を終えて回答を出力し終えたタイミングを検知し、音とバナーで通知します。

AIが考えている間、ずっとターミナルを見つめている必要はありません。「そろそろ終わったかな」とターミナルをチェックして、脳のコンテキストスイッチのコストを払い続ける必要もありません。プロンプトを送信したら、その場を離れましょう。`crai` が完了した瞬間だけお知らせします。
